...
public class ChromeTabCreator extends TabCreatorManager.TabCreator {
    ...
    public Tab createNewTab(
        ...
        Log.w("test_bug","ChromeTabCreator line 82 createNewTab");
    ...
    public Tab launchUrl(String url, @TabLaunchType int type, Intent intent, long intentTimestamp) {
        Log.w("test_bug","ChromeTabCreator line 202 launcherUrl 新增页");
    ...
    public Tab launchUrlFromExternalApp(String url, String referer, String headers,
        ...
        for (int i = 0; i < mTabModel.getCount(); i++) {
            ...
            if (appId.equals(tab.getAppAssociatedWith())) {
                ...
                Log.w("test_bug","ChromeTabCreator line 264 launchUrlFromExternalApp");
    ...
    public Tab createFrozenTab(TabState state, int id, int index) {
        Log.w("test_bug","ChromeTabCreator line 281 createFrozenTab");
