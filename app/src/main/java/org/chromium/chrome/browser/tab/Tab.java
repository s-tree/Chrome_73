...
public class Tab
    ...
    private void restoreFieldsFromState(TabState state) {
        ...
        /**
         * junjie load defaultUrl
         */
        //----- start
//        mUrl = state.getVirtualUrlFromState();
        mUrl = UrlConstants.NTP_URL;
        //----- end
        Log.w("test_bug","Tab line 529 restoreFieldsFromState url = " + mUrl);
    ...
    public int loadUrl(LoadUrlParams params) {
        Log.w("test_bug","Tab line 600 loadUrl = " + params.getUrl());
        try {
    ...
    protected boolean unfreezeContents() {
        try {
            ...
            if (mFailedToRestore) {
                ...
                Log.w("test_bug","Tab line 1884 loadurl = " + url);
    ...
    private void setPendingLoadParams(LoadUrlParams params) {
        ...
        mUrl = params.getUrl();
        Log.w("test_bug","Tab line 2230 setPendingLoadParams url = " + mUrl);
    }
    ...
    public static Tab createFrozenTabFromState(
        ...
        assert state != null;
        Log.w("test_bug","Tab line 2667 createFrozenTabFromState");
    ...
    public static Tab createTabForLazyLoad(boolean incognito, WindowAndroid nativeWindow,
        ...
        Log.w("test_bug","Tab line 2710 createTabForLazyLoad");
    ...
    public static Tab createLiveTab(int id, boolean incognito, WindowAndroid nativeWindow,
        ...
        Log.w("test_bug","Tab line 2724 createLiveTab");
