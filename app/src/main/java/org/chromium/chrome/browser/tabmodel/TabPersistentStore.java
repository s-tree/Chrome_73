...
public class TabPersistentStore extends TabPersister {
    ...
    public void restoreTabs(boolean setActiveTab) {
        ...
        if (setActiveTab) {
            ...
            while (!mTabsToRestore.isEmpty()
                ...
                Log.w("test_bug","TabPersistentStore line 491 restoreTabs setActiveTab = " + setActiveTab);
                TabRestoreDetails tabToRestore = mTabsToRestore.removeFirst();
                restoreTab(tabToRestore, true);
            }
        }
        Log.w("test_bug","TabPersistentStore line 500 will loadNextTab = " + setActiveTab);
        loadNextTab();
    }
    ...
    protected void restoreTab(
        ...
        if (tabState != null) {
            Log.w("test_bug","TabPersistentStore line 623 restoreTab");
